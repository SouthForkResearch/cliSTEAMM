...
geo_rca = r'C:\JL\Testing\STeAMM\MODIS_DataSource\RCAs\Yankee_Fork_RCAs.shp'
...
modis_wkt = prep.get_modis_wkt("steamm.py")
vrt_list = prep.convert_to_vrt(mosaic_io_array, swath_id, data_dir, dir_list, modis_wkt)
